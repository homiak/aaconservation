...
final class ExecutorFactory {
     ...
     * are cancelled.
     *
     * @param procNum the number of thread to initialize executor with. For the
     * purpose of AA conservation calculations for the maximum performance it is
     * recommended that the {@code procNum} is equal to the number of CPU cores.
     * procNum must not exceed 2xcores. If it does, then it will be initialized
     * with the n cores equal to the number of CPU cores on the machine and the
     * error message printed to the standard error stream.
     * @param statWriter the PrintWriter to dump the execution statistics to.
     */
     ...
     * voided.
     *
     * @param procNum the number of threads to use
     */
     ...
     * into the statWriter
     *
     * @param statWriter the PrintWriter to dump the execution statistics into
     */
