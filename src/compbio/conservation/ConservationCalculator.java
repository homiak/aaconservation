...
public class ConservationCalculator {
     ...
     *
     * @param alignment the list of FastaSequence objects holding the alignment.
     * All sequences must be of the same length.
     * @param normalize true if the resulting scores should be normalized, false
     * otherwise.
     *
     * @param methods the methods to be used for the calculation, all
     * {@link ConservationMethod} but SMERFS can be used. The {@link EnumSet}
     * class provides a number of convenience methods which can be used to
     * prepare a set of methods for the input. For example, to use
     * {@link ConservationMethod#KABAT} for conservation calculation one could
     * construct a set in the following way:
     * {@code EnumSet.of(ConservationMethod.KABAT)}.<br/>
     *
     * For all the methods, but SMERFS use the following construct:
     *
     * <br/> {@code EnumSet.complementOf(EnumSet.of(ConservationMethod.SMERFS))}
     * <br/>
     *
     * For a set of methods including KABAT, JORES, SCHNEIDER, SHENKIN, GERSTEIN
     ...
     *
     * @param executor the {@link ExecutorService} to be used to parallelize the
     * calculations
     * @return the Map of ConservationMethod->double[] conservation scores
     * @throws InterruptedException if the calculating Thread was interrupted
     */
     ...
     *
     * @param alignment the List of FastaSequence objects holding each sequence
     * from the alignment
     * @param windowWidth the window size parameter for SMERFS algorithm
     * @param scoringMethod the {@link SMERFSConstraints}
     * @param gapTreshold the gap threshold for SMERFS algorithm
     * @param normalize the boolean value indicating whether the resulting score
     * should be normalized, true if it does.
     * @param service the {@link ExecutorService} to be used to parallel
     * calculations
